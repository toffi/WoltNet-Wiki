...
ALTER TABLE wiki1_article ADD FOREIGN KEY (languageID) REFERENCES wcf1_language (languageID) ON DELETE SET NULL;
ALTER TABLE wiki1_article ADD FOREIGN KEY (userID) REFERENCES wcf1_user (userID) ON DELETE SET NULL;

ALTER TABLE wiki1_article_label ADD FOREIGN KEY (categoryID) REFERENCES wcf1_category (categoryID) ON DELETE CASCADE;

ALTER TABLE wiki1_article_label_to_object ADD FOREIGN KEY (labelID) REFERENCES wiki1_article_label (labelID) ON DELETE CASCADE;
ALTER TABLE wiki1_article_label_to_object ADD FOREIGN KEY (articleID) REFERENCES wiki1_article (articleID) ON DELETE CASCADE;
