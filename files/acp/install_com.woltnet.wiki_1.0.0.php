...
DashboardHandler::setDefaultValues('com.woltlab.wcf.user.DashboardPage', array (
		'com.woltnet.wiki.latestArticles' => 1 
));
DashboardHandler::setDefaultValues('com.woltnet.wiki.CategoryListPage', array (
		'com.woltnet.wiki.latestArticlesSidebar' => 1 
));
DashboardHandler::setDefaultValues('com.woltnet.wiki.CategoryPage', array (
		'com.woltnet.wiki.latestArticlesSidebar' => 1 
));
