...
class ArticlePage extends AbstractPage {
	...
	public function readParameters() {
		...
		if(isset($_GET['versionID']))
			$this->versionID = intval($_GET['versionID']);
	...
	public function readData() {
		...
		if(count($this->availableContentLanguages) > 0 && $this->languageID > 0 && $this->article->languageID != $this->languageID)
			HeaderUtil::redirect(LinkHandler::getInstance()->getLink('Article', array (
					'application' => 'wiki',
					'object' => $this->article->getArticleToLanguage($this->languageID),
					'l' => $this->languageID 
			)));
	...
	public function assignVariables() {
		...
		WCF::getTPL()->assign(array (
				...
				'tags' => TagEngine::getInstance()->getObjectTags('com.woltnet.wiki.article', $this->article->articleID, array (
