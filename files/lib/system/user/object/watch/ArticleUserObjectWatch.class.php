...
class ArticleUserObjectWatch extends AbstractObjectTypeProcessor implements IUserObjectWatch {
	...
	public function getUnreadCount($userID) {
		...
		$conditionBuilder->add('user_object_watch.objectTypeID = ?', array($this->objectTypeID));
		$conditionBuilder->add('user_object_watch.userID = ?', array($userID));
		$conditionBuilder->add('article.categoryID IN (?)', array($categoryIDs));
