...
class ArticlePermissionHandler extends SingletonFactory {
	...
	protected function init() {
		...
		$this->articlePermissions = ArticlePermissionCacheBuilder::getInstance()->getData(array (
				'groups' => $groups 
		));
	...
	public function getPermission($articleID, $permission) {
		if(isset($this->articlePermissions[$articleID][$permission]))
			return $this->articlePermissions[$articleID][$permission];
