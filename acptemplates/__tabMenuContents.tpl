<fieldset id="wikiCredits"
    ...
    <dl>
        ...
        <dd>
            <a href="{@$__wcf->getPath()}acp/dereferrer.php?url={http://www.woltnet.com|rawurlencode}" class="externalURL">WoltNet</a>
        </dd>
    </dl>
    ...
    <dl>
        ...
        <dd>
            <ul class="dataList">
                <li>Ren&eacute Gessinger, Jean-Marc Licht</li>
            </ul>
        </dd>
    </dl>
    ...
    <dl>
        <dt></dt>
        <dd>Copyright &copy; 2010-2012 WoltNet.</dd>
    </dl>
</fieldset>