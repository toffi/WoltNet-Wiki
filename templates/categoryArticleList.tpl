                    ...
                    <tr class="article jsClipboardObject{if $article->isNew()} new{/if}" data-article-id="{@$article->articleID}" data-category-id="{@$article->categoryID}" data-label-ids="[ {implode from=$article->getAssignedLabels() item=label}{@$label->labelID}{/implode} ]">
                        ...
                        <td class="columnText columnSubject">
                            ...
                            <h1>
                                ...
                                <a href="{link controller='Article' application='wiki' object=$article->getActiveVersion() categoryName=$article->getCategory()->getTitle()}{/link}" class="articleLink messageGroupLink framed" data-article-id="{@$article->articleID}">{$article->getActiveVersion()->getTitle()}</a>
                            </h1>
