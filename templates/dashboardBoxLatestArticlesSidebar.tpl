            ...
            {foreach from=$latestArticleList item=latestArticleObject}
                ...
                <li class="sidebarBox box24">
                    ...
                    <div class="sidebarBoxHeadline">
                        <h1><a href="{link controller='Article' object=$latestArticleObject category=$latestArticleObject->getCategory()}{/link}" class="wikiArticleTopicLink articleLink" data-article-id="{@$latestArticleObject->articleID}" data-sort-order="DESC" title="{$latestArticleObject->getTitle()}">{$latestArticle->Object->getTitle()}</a></h1>
