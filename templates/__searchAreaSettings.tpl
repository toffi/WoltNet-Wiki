...
{capture assign='__searchInputPlaceholder'}{if
$category|isset}{lang}wiki.category.searchCategory{/lang}{else}{lang}wiki.category.searchAllCategories{/lang}{/if}{/capture}
