                    ...
                    <footer class="messageOptions contentOptions marginTop clearfix">
                        <nav>
                            <ul class="smallButtons buttonGroup">
                                ...
                                {if !$article->isActive && $article->getModeratorPermission('canActivateArticle')}<li><a href="{link application='wiki' controller='ArticleVersionActivate' object=$article versionID=$article->versionID}{/link}" class="button jsTooltip" title="{lang}wiki.global.button.activate{/lang}"><span class="icon icon16 icon-ok"></span></a></li>{/if}
