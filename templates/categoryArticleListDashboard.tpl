<div
	class="marginTop tabularBox tabularBoxTitle shadow messageGroupList articleList">
	<header>
		<h1>
			{lang}com.woltnet.wiki.latestArticles{/lang} <span
				class="badge badgeInverse">{#$objects|count}</span>
		</h1>
	</header>
